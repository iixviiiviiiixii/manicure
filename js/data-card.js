...
const card = [
    // City Nails & Beauty
    {
        ...
        address: '<div class="address">Петроградский район, Кронверкский проспект 21/2<br>100 метров от метро Горьковская<br>+7 952 37 777 34<br><br>Калининский район, Финляндский вокзал<br>улица Комсомола, 35Ж<br>100 метров от метро Площадь Ленина<br>+7 952 211 01 12</div>',
